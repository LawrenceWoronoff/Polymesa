                    ...
                    <div class="row">
                        <div class="col-lg-4 px-4">  <!-- Personal Data -->
                            ...
                            <div class="mb-4 row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" value="jdavid18" id="example-text-input">
                                </div>
                            </div>
                            <!-- Image Part -->
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-9">
                                    <input class="form-control" type="text" value="David" id="example-text-input">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="example-text-input" class="col-md-3 col-form-label">Last name</label>
                                <div class="col-md-9">
                                    <input class="form-control" type="text" value="Hernandez" id="example-text-input">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="example-text-input" class="col-md-3 col-form-label">City</label>
                                <div class="col-md-9">
                                    <input class="form-control" type="text" value="Miami" id="example-text-input">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="example-text-input" class="col-md-3 col-form-label">Country</label>
                                <div class="col-md-9">
                                    <input class="form-control" type="text" value="United State" id="example-text-input">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="example-text-input" class="col-md-3 col-form-label">Date of birth</label>
                                <div class="col-md-9">
                                    <input class="form-control" type="date" value="2019-08-19" id="example-date-input" style="max-width:170px;">
                                </div>
                            </div>
                            <div class="mb-3 row">
                        ...
                        <div class="col-lg-4 px-4">  <!-- Online Profile & Options -->
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" type="text" value="http://palomarillo.com" id="example-text-input" placeholder="Your website url">
                                </div>
                            </div>
                            <div class="mb-3 row">
